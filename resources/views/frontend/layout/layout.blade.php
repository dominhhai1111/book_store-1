            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-phone"></i><span>+84 963 922 451</span></li>
                    </ul>
                </div>
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        <li><a href="shop-account.html">Đăng ký</a></li>
                        <li><a href="shop-wishlist.html">Đăng nhập</a></li>
                    </ul>
                </div>
                <!-- END TOP BAR MENU -->
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 text-right">
                    <p class="powered">Facebook: <a href="https://www.facebook.com/dung.nguyencong.56">Nguyễn Công Dũng</a></p>
                </div>
                <!-- END POWERED -->
            </div>
            <!-- </div> -->
