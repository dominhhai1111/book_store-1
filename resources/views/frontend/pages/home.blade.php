                ...
                <div class="item carousel-item-five">
                    <div class="container">
                        ...
                        <img class="carousel-position-five animate-delay hidden-sm hidden-xs"
                             src="assets/pages/img/shop-slider/slide2/price.jpg" alt="Price"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 steps-block-col">
                        ...
                        <div>
                            <h2>Quà tặng</h2>
                            <em>3 món quà hấp dẫn cho khách hàng may mắn</em>
                        </div>
                        <span>&nbsp;</span>
                    </div>
                    <div class="col-md-4 steps-block-col">
